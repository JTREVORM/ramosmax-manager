...
| 9 — next | Not started |
| Later | reports · full notifications |

## Role menus (implemented in `RoleNavigation`)

| Role | Menu |
|---|---|
| Admin | Dashboard, New Service, Vehicles, Customers, Services, Jobs, Invoices, Payments, Receipts, Credit, Loyalty, Staff, Finance, Expenses, Inventory, Attendance, Allowances, Payroll, Loss Incidents, Shareholders, Shares, Dividends, After-Hours, Reports, User Management, Settings, Audit |
...
| Auditor | Dashboard, Audit Logs, Finance, Transactions, Expenses, Inventory, Payroll, Attendance, Allowances, Loss Incidents, Reconciliation, Discrepancies, After-Hours, User Management, Jobs, Invoices, Payments, Receipts, Credit, Loyalty, Vehicles, Customers, Services, Shareholders, Shares, Dividends (all read-only) |
