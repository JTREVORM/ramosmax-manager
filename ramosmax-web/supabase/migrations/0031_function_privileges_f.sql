-- ===========================================================================
-- RamosMAX Web — Phase F — 0031: execute privileges for the workforce functions
-- ===========================================================================
-- Same model as 0014 and 0020: deny by default, allow an explicit list.
-- PostgreSQL grants EXECUTE to PUBLIC on every new function, so the revoke is
-- repeated here and the list below is the whole browser-callable surface added
-- by Phase F.
-- ===========================================================================
...
--   app.calculate_payroll            recalculating a payroll outside prepare/correct
--   app.salary_version_on            reading anyone's salary version
--   app.allowance_amount,
--   app.allowance_ineligibility,
--   app.allowance_suggestion         the allowance rules, applied by the server
--   app.lateness, app.incident_status,
--   app.policy_int, app.policy_bool,
--   app.read_employee, app.require_*,
--   app.guard_*                      internal helpers and triggers
--
